 ...
 * Description:
 * ------------
 *   This example demonstrates how to use time function with APIs in QuecOpen.
...
void proc_main_task(s32 taskId)
{
    ...
    time.minute = 30;
    time.second = 18;
    time.timezone = 32; // The range is(-47~48). one digit expresses 15 minutes, for example: +32~+35 indicates East eight district.
