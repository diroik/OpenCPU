 ...
 * Description:
 * ------------
 *   This example demonstrates how to use system function with APIs in QuecOpen.
 ...
 *     If input "Ql_Delay_ms=<xxx>", that will suspends the execution of the current
