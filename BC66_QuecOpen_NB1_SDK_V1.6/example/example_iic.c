 ...
 * Description:
 * ------------
 *   This example demonstrates how to use iic function with APIs in QuecOpen.
        ...
        case EVENT_UART_READY_TO_READ:
        {
            ...
            if(p)
            {
                ...
                {                    
                    ...
                    APP_DEBUG("\r\n<--pins(SCL=%d,SDA=%d) Ql_IIC_Init channel 0 ret=%d-->\r\n",PINNAME_GPIO4,PINNAME_GPIO5,ret);
                    break;
                }
                else if(1 == IIC_type)// IIC controller
                {
                    ...
                    APP_DEBUG("\r\n<--pins(SCL=%d,SDA=%d) Ql_IIC_Init channel 1 ret=%d-->\r\n",PINNAME_RI,PINNAME_DCD,ret);
                    break;
