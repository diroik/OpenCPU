 ...
 * Description:
 * ------------
 *   This example demonstrates how to use watchdog function with APIs in QuecOpen.
...
void proc_main_task(s32 TaskId)
{
    ...
    while (TRUE)
    {
        ...
        switch(msg.message)
        {
            // Application will receive this message when QuecOpen RIL starts up.
