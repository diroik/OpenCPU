...
GPIO_ITEM(PINNAME_USB_MODE,		  PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_GPIO6,		  PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_GPIO7,		  PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_GPIO8,		  PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
#endif
