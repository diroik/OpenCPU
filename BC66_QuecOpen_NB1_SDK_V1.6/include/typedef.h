...
typedef struct{
    ...
    s32				buttonCnt;//вспомогательна€ переменна€ in GPIO_INPUT_TIMER_PERIOD ms (10)
    s32 		   	in1Cnt;//вспомогательна€ переменна€ дл€ избежани€ дребезга
    s32				in2Cnt;//вспомогательна€ переменна€ дл€ избежани€ дребезга
    bool 			HbuttonState;
    bool 			Hin1State;
    bool 			Hin2State;
    u32            	rebootCnt;
