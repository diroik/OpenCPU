...
*
*		    IicSpeed:
*		            [In] just used for hardware IIC, and the parameter can be ignored when using simulation IIC, refer to hal_i2c_frequency_t.
*               
*
* Return:        
*               QL_RET_OK, this function succeeds.
...
*****************************************************************/
s32 Ql_IIC_Config(u32 chnnlNo, bool isHost, u8 slaveAddr, hal_i2c_frequency_t IicSpeed);
