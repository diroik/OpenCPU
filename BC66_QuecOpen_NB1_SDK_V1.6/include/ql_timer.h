...
* 
* Description:
*               Register stack timer, the whole quecopen project supports 90 stack timers.
*
* Parameters:
*               timerId:
*                       [in] The timer id must be bigger than 0xFF.And make sure that the id is
*                            the only one under quecopen task.Of course, the ID that registered 
...
* 
* Description:
*               Register GP timer, the whole quecopen project supports 6 GP timers.
*
* Parameters:
*               timerId:
*                       [in] The timer id must be bigger than 0xFF.And make sure that the id is
...
* 
* Description:
*				Register GP timer,only support one timer under quecopen project.
*
* Parameters:
*				timerId:
