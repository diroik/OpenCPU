/**
* the LWIP configuration file of qcx2120h00 project
**/
...
#define PS_NETIF_DEFAULT_MTU                 1400
#endif
...
#if defined ENABLE_PSIF
#define PBUF_POOL_MM_USE_CUSTOM 1
...
#define PSIF_MAX_PKG_DUMP_LEN   1500
...
#if !defined LWIP_NONIP || defined __DOXYGEN__
#define LWIP_NONIP                        1
#endif
/**
...
#define TCP_DEFRTX_TOTAL_TIME                      60
#endif
...
/**
 * QUECTEL_TCPIP_EVENT_API == 1 can support ( LWIP_EVENT_API == 1 and LWIP_CALLBACK_API == 1 )
 */
#ifdef QUECTEL_AT_SUPPORT
#define QUECTEL_TCPIP_EVENT_API	1
#endif
...
#if !defined DEFAULT_NONIP_RECVMBOX_SIZE || defined __DOXYGEN__
#define DEFAULT_NONIP_RECVMBOX_SIZE       8
#endif
/**
