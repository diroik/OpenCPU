...
OS_CODE_IN_RAM uint32_t osThreadFlagsSet (osThreadId_t thread_id, uint32_t flags) {
...
OS_CODE_IN_RAM osStatus_t osMessageQueuePut (osMessageQueueId_t mq_id, const void *msg_ptr, uint8_t msg_prio, uint32_t timeout) {
  osStatus_t stat;
  BaseType_t pxHigherPriorityTaskWoken = pdFALSE;
