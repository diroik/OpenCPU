...
GPIO_ITEM(PINNAME_PCM_CLK,        PINDIRECTION_OUT,    PINLEVEL_HIGH,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_PCM_SYNC,       PINDIRECTION_IN,    PINLEVEL_HIGH,  PINPULLSEL_DISABLE)
GPIO_ITEM(PINNAME_PCM_IN,         PINDIRECTION_IN,    PINLEVEL_HIGH,  PINPULLSEL_DISABLE)
GPIO_ITEM(PINNAME_PCM_OUT,        PINDIRECTION_IN,    PINLEVEL_HIGH,  PINPULLSEL_DISABLE)
#endif
