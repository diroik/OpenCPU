...
static const ST_PowerKeyCfg pwrkeyCfg = {
		TRUE, //TRUE,  // working mode for power-on on PWRKEY pin
    /*
    ...
    */
		...
		TRUE, //TRUE,  // working mode for power-off on PWRKEY pin
    /*
...
static const ST_ExtWatchdogCfg wtdCfg = {
		PINNAME_RI, //PINNAME_PCM_OUT,  // Specify a pin which connects to the external watchdog
