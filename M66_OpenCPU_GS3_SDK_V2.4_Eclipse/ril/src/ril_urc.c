...
static void OnURCHandler_MQTT_OPEN(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage(URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_OPEN, (u32)&mqtt_urc_param);
	}
...
static void OnURCHandler_MQTT_CONN(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage(URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_CONN, (u32)&mqtt_urc_param);
	}
}
static void OnURCHandler_MQTT_SUB(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_SUB, (u32)&mqtt_urc_param);
	}
...
static void OnURCHandler_MQTT_PUB(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_PUB, (u32)&mqtt_urc_param);
	}
}
static void OnURCHandler_MQTT_TUNS(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_TUNS, (u32)&mqtt_urc_param);
	}
}
...
static void OnURCHandler_MQTT_STATE(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_STATE, (u32)&mqtt_urc_param);
	}
}
static void OnURCHandler_MQTT_CLOSE(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_CLOSE, (u32)&mqtt_urc_param);
	}
}
...
static void OnURCHandler_MQTT_DISC(const char* strURC, void* reserved)
{
	...
	*p2 = '\0';
	...
	if (p1)
	{
		...
		Ql_OS_SendMessage((s32)URC_RCV_TASK_ID, MSG_ID_URC_INDICATION, URC_MQTT_DISC, (u32)&mqtt_urc_param);
	}
}
